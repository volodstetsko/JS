...
// console.log(filter3); // за умови якщо 6-10 цифрові значення

// let filter4 = deckOfCards.filter(value => value.cardSuit === 'spade' && value.value > '8' || value.value === '10' &&
// value.cardSuit === 'spade' || value.value === 'Joker' && value.color === 'black');
// console.log(filter4); // за умови якщо 6-10 стрінгові значення
